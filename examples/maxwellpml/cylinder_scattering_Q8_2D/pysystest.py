__pysys_title__   = r""" Maxwell PML: Q8 Cylinder Scattering """ 
#                        ==========================
__pysys_purpose__ = r""" Check for the Maxwell equations with perfectly matched layers and scattering and a cylinder""" 
...
trackfile = 'simulation_probe_electricField_Q8_pml_circMaterial_p00000.res'

from apes.apeshelper import ApesHelper
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        self.copy(self.input + '/hyperfun.lua', self.output)
        self.apes.setupAteles(atlfile='ateles_recheck_Q8_maxwell_2d.lua')
