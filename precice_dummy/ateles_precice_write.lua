...
precice = {
           accessor = 'Ateles',
           configFile ='config_write.xml',
           meshname = 'AcousticSurface',
           exchange_data_read =  {'Density_in', 'Velocities_in', 'Pressure_in'},
           exchange_data_write =  {'Density_out', 'Velocities_out', 'Pressure_out'}
