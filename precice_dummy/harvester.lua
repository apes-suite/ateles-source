...
-- define the input
input = {
         --read = './restart/gPulseDens_euler_modg_header_00000000.000E+00.lua',
         --read = './restart/gPulseDens_euler_modg_header_0.000E+00.lua',
         --read = './restart/gPulseDens_euler_modg_header_200.000E-06.lua',
         --mesh = './mesh/',
         read = '$!filename!$'
